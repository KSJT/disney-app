  ...
  return (
    <Container>
      ...
      <Wrap>
        ...
        <video autoPlay loop muted>
          <source src="/videos/pixar.mp4" alt="pixar" type="video/mp4"/>
        </video>
      </Wrap>
      <Wrap>
        <img src="/images/viewers-starwars.png" alt="star-wars" />
        <video autoPlay loop muted>
          <source src="/videos/star-wars.mp4" alt="star-wars" type="video/mp4"/>
        </video>
      </Wrap>
      <Wrap>
        <img src="/images/viewers-national.png" alt="national" />
        <video autoPlay loop muted>
          <source src="/videos/national-geographic.mp4" alt="national" type="video/mp4"/>
        </video>
      </Wrap>
    </Container>
